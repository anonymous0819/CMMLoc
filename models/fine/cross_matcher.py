...
class CrossMatch(torch.nn.Module):
    ...
    def forward(self, objects, hints, object_points):
        ...
        ## CDI Matrix computation: trade-off between memory usage and training time, if your GPU memory is less than 82GB, you can perfrom calculations in the object encoder or use distributed training. ##
        loc_info_list = []
